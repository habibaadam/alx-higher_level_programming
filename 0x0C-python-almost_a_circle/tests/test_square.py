...
"""Defining unittests for square.py
                ...
                Testsquare_order_of_init - Line 307 
                Testsquare_area - Line 323
                TestSquare_stdout - Line 344
                Testsquare_updating_args - Line 427
                Test_square_updating_kwargs - Line 539 
                Testsquare_to_dict - Line 641
...
class Testsquare_instantiation(unittest.TestCase):
    ...
    def test_size_priv(self):
        with self.assertRaises(AttributeError):
            print(Square(4, 5, 0, 0).__size)
...
class Testsquare_updating_args(unittest.TestCase):
